...
*/
            ...
            wordsAndDefinitions.Add("Excited", "super amped up!!!!!");

            wordsAndDefinitions.Add("Sad", "not very amped up at all");
...
Dictionary<string, string> tacoWord = new Dictionary<string, string>(){
    {"word", "taco"},
    {"definition", "delicious food thing"},
    {"part of speech", "noun"},
    {"example sentence", "I would like to eat a taco"},
};

dictionaryOfWords.Add(tacoWord);
